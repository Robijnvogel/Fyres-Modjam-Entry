...
public class RenderMysteryPotion extends Render
{
	...
	{
		IIcon icon = (par1Entity instanceof EntityMysteryPotion) ? field_94151_a.getIconFromDamage(par1Entity.getDataWatcher().getWatchableObjectInt(24)) : field_94151_a.getIconFromDamage(0);
